  ...
  setup() {
    ...
    const colorClasses = (bg) => {
      switch (bg) {
        ...
        case 'dark':
          return 'bg-zinc-800 text-gray-100 border-gray-700/60'
        default:
          return 'text-gray-600 bg-white dark:bg-zinc-800 dark:text-gray-100 border-gray-200 dark:border-gray-700/60'
      }
    }      
