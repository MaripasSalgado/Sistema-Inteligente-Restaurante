<template>
  <div>
    ...
    <label
      class="flex items-center justify-center cursor-pointer w-8 h-8 hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-zinc-700/50 dark:lg:hover:bg-zinc-800 rounded-full"
      for="light-switch">
