  ...
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      <div>
        ...
        <p class="text-gray-400 mt-1">Administra las categorías de insumos</p>
      </div>
      <button
          ...
          <div>
            ...
            <div class="flex items-center space-x-4">
              ...
              <input
                v-model="formulario.color"
                type="text"
                class="flex-1 px-3 py-2 bg-zinc-900/95 border border-zinc-700/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
                placeholder="#f4b400"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-8 gap-2">
              <button
                ...
                :class="formulario.icono === icono ? 'bg-violet-500 border-violet-500' : 'bg-black'"
              >
                {{ icono }}
              </button>
            </div>
