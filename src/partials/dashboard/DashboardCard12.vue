<template>
  <div class="col-span-full xl:col-span-6 bg-zinc-900/80 border border-zinc-700/50 shadow-xs rounded-xl">
    ...
    <div class="p-3">
      ...
      <!-- "Today" group -->
      <div>
        <header class="text-xs uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-zinc-700/50 rounded-xs font-semibold p-2">Today</header>
        <ul class="my-1">
          <!-- Item -->
          <li class="flex px-2">
            ...
            <div class="grow flex items-center border-b border-gray-100 dark:border-gray-700/60 text-sm py-2">
              <div class="grow flex justify-between">
                ...
                <div class="shrink-0 self-end ml-2">
                  <a class="font-medium text-amber-500 hover:text-amber-600 dark:hover:text-amber-400" href="#0">View<span class="hidden sm:inline"> -&gt;</span></a>
                </div>
              </div>
            </div>
          </li>
      ...
      <!-- "Yesterday" group -->
      <div>
        <header class="text-xs uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-zinc-700/50 rounded-xs font-semibold p-2">Yesterday</header>
        <ul class="my-1">
          <!-- Item -->
          <li class="flex px-2">
